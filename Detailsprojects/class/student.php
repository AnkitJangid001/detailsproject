...
class Student
{
    ...
    public function create_student_info($post_data=array()){
       ...
       $email_address= mysqli_real_escape_string($this->conn,trim($post_data['email_address']));
        $address= mysqli_real_escape_string($this->conn,trim($post_data['address']));
              $house= mysqli_real_escape_string($this->conn,trim($post_data['house']));
       ...
       $sql="INSERT INTO students (student_name, email_address, contact,country,address,house) VALUES ('$student_name', '$email_address', '$contact','$country','$address','$house')";
    ...
    public function update_student_info($post_data=array()){
       ...
       $sql="UPDATE students SET student_name='$student_name',email_address='$email_address',contact='$contact',country='$country',address='$address',house='$house' WHERE student_id =$student_id";
